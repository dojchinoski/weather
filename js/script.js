...
let image = document.querySelector(".weather__img");
let temperature = document.querySelector(".weather__value");
let forecastBlock = document.querySelector(".weather__forecast");
let suggestions = document.querySelector("#suggestions");
let weatherAPIKey = "b51199c51f0f614b58323b0a3edf30ca";
...
let updateCurrentWeather = (data) => {
  ...
  city.textContent = data.name + ", " + country;
